...
import ar.edu.utn.frba.dds.model.entities.algoritmosconcenso.ModoNavegacion;
import ar.edu.utn.frba.dds.model.entities.algoritmosconcenso.NavegacionIrrestricta;
...
public class TestsFuenteDataSet {
  ...
  public void fixtureColeccion() {
    ...
    dataset = new FuenteDataSet("uploads/hechos_argentina.csv","yyyy-MM-dd HH:mm",',');
