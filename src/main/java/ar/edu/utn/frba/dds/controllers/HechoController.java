...
public class HechoController implements WithSimplePersistenceUnit {
  ...
  public Map<String, Object> showCreationForm(@NotNull Context ctx) {
    boolean esRegistrado =
        ctx.attribute("userRole") == AppRole.USER
            || ctx.attribute("userRole") == AppRole.ADMIN;
  ...
  public void create(@NotNull Context ctx) {
    ...
    try {
      ...
      if (latStr == null || lonStr == null) {
        throw new IllegalArgumentException("Debe especificar latitud y longitud");
      }
      ...
      if (multimediaFile != null
          && multimediaFile.filename() != null
          && !multimediaFile.filename().isBlank()) {
  ...
  public Map<String, Object> showBusquedaForm(@NotNull Context ctx) {
    ...
    if (titulo != null) {
      filtrosForm.put("titulo", titulo);
    }
    if (categoria != null) {
      filtrosForm.put("categoria", categoria);
    }
    if (descripcion != null) {
      filtrosForm.put("descripcion", descripcion);
    }
    ...
    if (longitud != null) {
      filtrosForm.put("longitud", longitud);
    }
    if (latitud != null) {
      filtrosForm.put("latitud", latitud);
    }
    if (fechaAcontecimiento != null) {
      filtrosForm.put("fechaAcontecimiento", fechaAcontecimiento);
    }
    ...
    if (fechaCarga != null) {
      filtrosForm.put("fechaCarga", fechaCarga);
    }
    if (fechaDesde != null) {
      filtrosForm.put("fechaDesde", fechaDesde);
    }
    if (fechaHasta != null) {
      filtrosForm.put("fechaHasta", fechaHasta);
    }
    ...
    if (sePresionoBuscar) {
      ...
      if (titulo != null && !titulo.isEmpty()) {
        filtros.add(new CriterioTitulo(titulo));
      }
      if (categoria != null && !categoria.isEmpty()) {
        filtros.add(new CriterioCategoria(categoria));
      }
      if (descripcion != null && !descripcion.isEmpty()) {
        filtros.add(new CriterioDescripcion(descripcion));
      }
      if (longitud != null && !longitud.isEmpty() && latitud != null && !latitud.isEmpty()) {
        filtros.add(new CriterioUbicacion(Double.parseDouble(latitud),
      ...
      if (fechaDesde
          != null && !fechaDesde.isEmpty() && fechaHasta
          != null && !fechaHasta.isEmpty()) {
        filtros.add(
            new CriterioRangoFechas(LocalDate.parse(fechaDesde), LocalDate.parse(fechaHasta))
        );
      }
